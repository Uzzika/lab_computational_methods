...
def plot_results(results):
    ...
    plt.bar(x, sugar_values, width=0.4, label="Выход сахара", align='center', color='#FFA400')
    plt.bar(x, losses_values, width=0.4, label="Относительные потери", align='edge', color='#1049A9')
